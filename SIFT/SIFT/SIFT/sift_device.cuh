...
void dev_calculate_gradient_maps(unsigned char* baseImage, float* gradientMagnitudeMap, unsigned char* gradientOrientationMap, int width, int height);
...
__global__ void gradient_map_kernel(unsigned char* input, float* magnitudeMap, unsigned char* orientationMap, int height, int width);
...
__global__ void orientation_histogram_kernel(unsigned char* keyMask, unsigned char* orientationMap, float* gaussianKernel, int width, int height, int x, int y, int idx);
